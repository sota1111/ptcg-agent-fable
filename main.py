"""fable submission entry point (SOT-1795).

Champion determinized MCTS (matsu SOT-1672/1693 lineage) with the SOT-1795
...
from agents import GreedyAgent, MctsAgent, RuleAgent, actions
...
# fable v1 configuration. Search parameters are the matsu champion settings
...
class SubmissionAgent:
    ...
    from the raw observation (SOT-1795 chain: MCTS -> Greedy -> Rule ->
...
def agent(obs_dict: dict) -> list:
    """Pokémon Trading Card Game Agent (fable determinized MCTS, SOT-1795).
